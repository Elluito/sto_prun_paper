...
% \begin{table}[!htb]
%     \centering
%     \caption{Median Weight magnitude per layer}
%     \begin{tabular}{|l|l|}
%     \hline
...
\begin{algorithm}[!tb]
   ...
   \begin{algorithmic}[1]
    ...
    \STATE {\bfseries Initialise:} $w_r \gets w^*$,$p_r \gets 0$ 
    \STATE\COMMENT{Our reference model
is initialised to the original model}
